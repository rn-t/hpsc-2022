...
int main (int argc, char** argv) {
  ...
  for(int i=0; i<2; i++) stride[i] *= Nlocal[i];
  ...
  hsize_t Nlocal_2[2] = {Nlocal[0] * 2, Nlocal[1] * 2};

  //hid_t localspace = H5Screate_simple(2, Nlocal, NULL);
  hid_t localspace = H5Screate_simple(2, Nlocal_2, NULL);
